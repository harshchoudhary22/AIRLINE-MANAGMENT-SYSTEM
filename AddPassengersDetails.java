...
public class AddPassengersDetails extends JFrame implements ActionListener
{
    ...
    {
       f=new JFrame("Add Passanger Details");
       ...
       l1.setLayout(null);
        ...
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("AMS/icons/flight02.jpg"));
        ...
        l3=new JLabel("Welcome to the Airline India");
